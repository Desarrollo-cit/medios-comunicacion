        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                <div class="modal-header ">
                    <h5 class="modal-title " id="modalIngresoLabel">INGRESO DE INCIDENTES</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body container ">
                    <form id="formInformacion" class="badge-light p-1">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" name="latitud" id="latitud" class="form-control" novalidate>
                            </div>
                            <div class="col">
                                <label for="longitud">Longitud</label>
                                <input type="text" name="longitud" id="longitud" class="form-control" novalidate>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col">
