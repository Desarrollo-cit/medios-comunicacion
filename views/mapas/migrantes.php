    ...
    <div class=" ms-1 col border border-2 border-dark  pt-3 bg-light rounded">
        ...
        <div class=" col-lg-12  justify-content-center">
            <div class="row mb-2 ">
                <div class="justify-content-center d-flex ">
                    <h1> Resumen de Migracion en el mes de <?php echo     $fechaLarga; ?>
        ...
        <div class="row mb-3">
            <div class="col-lg-1 text-center">
                <div class="row">
                    <div class="col">
                        <p class="h5">Migrantes </p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-8">
                        <img src="<?= asset('./images/9.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="cantidad_migrantes"><?= number_format($migrantes[0]['cantidad']) ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 text-center">
                <div class="row">
                    <div class="col">
                        <p class="h5"> Edad Incurrente</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-4">
                        <img src="<?= asset('./images/iconos/capturas/delito.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="edad_concurrente"><?= $edades[0]['edades'] ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 text-center">
                <div class="row">
                    <div class="col">
                        <p class="h5">Paises incurrentes en Migracion</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-4">
                        <img src="<?= asset('./images/iconos/migrantes/mundo.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="cantidad_paises"><?= $cant_paises[0]['cantidad'] ?></p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 text-center">
                <div class="row">
                    <div class="col">
                        <p class="h5"> Pais con mas incidencia de migracion</p>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-4">
                ...
                <div class="row">
                    <div class="col">
                        <p class="h3" id="pais_migrante"><?= $pais[0]['pais'] ?></p>
                    </div>
                </div>
            </div>
            <div id="mes_elegido" class="col-lg-1 text-center">
                <div class="row">
                    <div class="col">
                        <p class="h5"> Mes</p>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-8">
                        <img src="<?= asset('./images/iconos/calendario.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="fecha_resumen"><?php echo strtoupper($fechaLarga) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-1 text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-8">
                        <img src="<?= asset('./images/iconos/capturas/mujer.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="cantidad_mujeres"><?= number_format($mujeres[0]['cantidad']) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-1 text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-8">
                        <img src="<?= asset('./images/iconos/capturas/hombre.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p class="h3" id="cantidad_hombres"><?= number_format($hombres[0]['cantidad']) ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-2 text-center">
                ...
                <div class="row justify-content-center">
                    <div class="col-2 col-sm-4">
                        <img src="<?= asset('./images/iconos/ubicacion.png') ?>" class="w-100" alt="migrantes">

                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <p id="depto_mayor" class="h3"><?= $depto[0]['desc'] ?></p>
                    </div>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="modalmigrante" name="modalmigrante" tabindex="-1" role="dialog" aria-labelledby="infoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title " id="infoModalLabel">Informacion de los migrantes</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body container">

                <div class="modal-body container ">
                    <form id="formInformacion1" class="badge-light p-1 was-validated">
...
<script src="../public/build/js/mapas/infoMigrantes.js"></script>