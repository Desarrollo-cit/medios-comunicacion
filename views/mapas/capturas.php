...
-->
    ...
    <div class=" ms-4 container-fluid text-center pt-2" id="mapa_calor">
        <div class="justify-content-center">
                                ...
                                <div class="  col-lg-12 justify-content-center">
                                    <div class="row mb-3">
                                        <div id="cuadro_busquedad_mapa" style="display:none;">
                                            <form class=" col-lg-11 border border-2 border-dark  pt-3" id="formBusqueda_mapa" style="background-color:black; border-radius:10px;">
                                                <div class="row mb-3">
                                                    <div class="col">
                                                        <h2 style="color: white;">Ingrese los criterios de busqueda</h2>
                                                    </div>
                                        ...
                                        <div class="col-lg-7 pt-2">
                                            ...
                                            <svg baseprofile="tiny" fill="#7c7c7c" height="1000" stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" version="1.2" viewbox="0 0 1000 1056" width="1200" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div class="pt-5 col-lg-5 align-items-start justify-content-start">
                                            ...
                                            <div class="row mb-2 ">
                                                ...
                                                <div class="col-4  justify-content-end ms-2">
                                                    ...
                                                    <div style="border:solid; width:50px; height:50px; background-color:#0F4A13"></div>
                    ...
                    <form id="formdeptoinfo" class= "  badge-light p-1 was-validated">
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-4 justify-content-start">
                                <label for="depto"><h3> Cantidad de capturas:</h3></label>
                                </div>
                        ...
                        <div class="row mb-1">
                            <div class="col-lg-2 ms-3 ">
                                <label  for="depto"><h3 id="label_delito"><span> Incidencia: </span></h3></label>
                                </div>
